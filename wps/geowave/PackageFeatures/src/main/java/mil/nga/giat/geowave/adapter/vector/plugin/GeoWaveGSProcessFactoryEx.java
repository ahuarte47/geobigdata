...
/**
 * This is the GeoTools Factory for introducing some extra modules to manage big-stores.
 * GeoTools uses Java SPI to inject the WPS process (see META-INF/services/org.geotools.process.ProcessFactory).
 */
